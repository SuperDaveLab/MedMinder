...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['nexpill-icon.svg', 'screenshot-care.svg', 'screenshot-admin.svg'],
      manifest: {
        id: '/',
        ...
        shortcuts: [
          {
            ...
            url: '/?view=care',
            icons: [{ src: 'nexpill-icon.svg', sizes: '192x192', type: 'image/svg+xml' }],
          },
          {
            name: 'History',
            short_name: 'History',
